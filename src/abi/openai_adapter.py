...
def _build_selected_nonlocal_law_candidate_reader_state_prompt(input_text: str) -> str:
    return (
        ...
        "rival pressure, and all risk probes. Return risk probes in "
        "risk_probe_results_by_id using exactly these six IDs, with no omissions, "
        "substitutions, paraphrases, or merged probes: "
        ...
        "object_field_delicacy_overloaded_by_causal_explanation. Include every "
        "probe even when the risk is inactive; missing any required probe "
        "invalidates the model call. Keep synthesis_authorized, "
