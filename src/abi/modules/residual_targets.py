...
PROOF_NO_ANSWER_MATERIALITY_POLICY = ResidualMaterialityPolicy(
    ...
    prompt_feedback=(
        ...
        "do not satisfy no_outside_answer_embodied_in_room by paraphrasing No answer enters from outside the room",
        "do not swap enters for crosses, arrives, comes, or appears without materially embodying the absence in room/object pressure",
        "object carry alone does not satisfy answer_absence_registered_by_objects unless the objects also register that no outside answer arrives",
...
PROOF_NO_ANSWER_RESIDUE_ADAPTER = ResidualTargetAdapter(
    ...
    prompt_instructions=(
        ...
        "do not satisfy no_outside_answer_embodied_in_room by changing enters to crosses, arrives, comes, or appears",
        "make no outside answer perceptible through room, object, line, mark, or pressure rather than denial language alone",
        "make answer_absence_registered_by_objects register absence through objects, not merely carry proof nearby",
