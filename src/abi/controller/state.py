...
AUTONOMOUS_LOCAL_LAW_DISCOVERY_ACTIVE_PHASE = (
    "local_law_discovery_from_rival_forensics_v1"
)
...
AUTONOMOUS_NONLOCAL_LAW_GUIDED_WORK_ORDER_ACTIVE_PHASE = (
    "nonlocal_law_guided_work_order_v1"
)
...
AUTONOMOUS_NONLOCAL_LAW_CANDIDATE_ABLATION_ACTIVE_PHASE = (
    "nonlocal_law_candidate_ablation_v1"
)
...
AUTONOMOUS_NONLOCAL_LAW_SELECTED_TARGET_CYCLE_WORK_ORDER_ACTIVE_PHASE = (
    "nonlocal_law_selected_target_cycle_work_order_v1"
)
AUTONOMOUS_NONLOCAL_LAW_SELECTED_TARGET_CYCLE_GENERATION_AUTHORIZATION_ACTIVE_PHASE = (
    "nonlocal_law_selected_target_cycle_generation_authorization_v1"
)
